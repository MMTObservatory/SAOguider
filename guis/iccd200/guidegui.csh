...
setenv inst oldiccd200sm
grep '^[a-z]' $SAOGUIDER_ROOT/guis/iccd200/guidserv.unique.rc | cut -d'#' -f1 | cat -n | nc `echo $GUIDSERV | tr ":" " "` > /dev/null
setenv MSGINITDIR $SAOGUIDER_ROOT/guis/iccd200
