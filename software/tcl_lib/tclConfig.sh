...
# installed.
TCL_PREFIX='/data/mmti'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/data/mmti'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/data/mmti/pkg/tcl8.4.3/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/data/mmti/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/data/mmti/include'
...
# compiled.
TCL_SRC_DIR='/data/mmti/pkg/tcl8.4.3'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/data/mmti/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/data/mmti/pkg/tcl8.4.3/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/data/mmti/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/data/mmti/pkg/tcl8.4.3/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/data/mmti/lib/libtclstub8.4${TCL_DBGX}.a'
